...
internal enum Asset {
  ...
  internal static let backgroundBlueColor = ColorAsset(name: "background_blue_color")
  ...
  internal static let disabledDarkGrayColor = ColorAsset(name: "disabled_dark_gray_color")
